...
PartPost_normal =  function(mcmc_samples = 4000, burn_in = 2000, y, x, zeta_ppd, likelihood_indicator = 1, 
...
PartPost_normal_nonridge =  function(mcmc_samples = 4000, burn_in = 2000, y, x, zeta_ppd, likelihood_indicator = 1, 
