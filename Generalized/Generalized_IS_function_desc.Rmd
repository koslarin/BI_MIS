...
* **nugget_prop**: A numeric scalar in `[0,1)` defining the proportion of total Z-space marginal variance allocated to the nugget floor. Defaults to `0.10` (10% nugget). used to prevent over-smoothing.
